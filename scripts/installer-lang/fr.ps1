[PSCustomObject]@{
    ...
    OldV3           = "La mise à jour {1} fonctionne à moitier, Voulez-vous faire la mise à jour ? [Y/N]"
    ...
    NoRestore       = "SpotX a déjà été installé, mais les fichiers xpui.js.bak et xpui.css.bak qui sont à récupérer n'ont pas été trouvés. `nVeuillez désinstaller le client Spotify et relancez à nouveau Install.exe."
    ExpSpotify      = "Fonctions expérimentales exploitées par Spotify"
    ExpStandart     = "Fonctions expérimentales de SpotX non incluses"
    NoRestore2      = "SpotX a déjà été installé, xpui.bak introuvable. `nMerci de désinstaller le client Spotify et de lancer à nouveau Install.exe"
