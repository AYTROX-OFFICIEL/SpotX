[PSCustomObject]@{
    ...
    NewV2           = "Votre version {0} de Spotify n'a pas encore été testée, actuellement la dernière version testé est la version {1}"
    ...
    PodcatsSelect   = "Voulez-vous désactiver les podcasts, les épisodes et les livres audio de la page principale? [Y/N]" #
    ...
    NoRestore       = "SpotX a déjà été installé, mais les fichiers xpui.js.bak et xpui.css.bak qui sont à récupérer n'ont pas été trouvés. `nVeuillez désinstaller le client Spotify et relancez à nouveau avec le launcher."
    ExpSpotify      = "Fonctions expérimentales exploitées par Spotify"
    ExpStandart     = "Fonctions expérimentales de SpotX non incluses"
    NoRestore2      = "SpotX a déjà été installé, xpui.bak introuvable. `nMerci de désinstaller le client Spotify et de lancer à nouveau avec le launcher."
